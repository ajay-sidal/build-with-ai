...
export default function HomePage() {
  ...
  return (
    <>
      {/* Animated Background */}
      <div className="fixed inset-0 bg-gradient-animated -z-10" />
      
      {/* Particle Effect Overlay */}
      <div className="fixed inset-0 opacity-20 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,_rgba(0,212,255,0.15)_1px,_transparent_0)] bg-[length:40px_40px]" />
      </div>
      ...
      <main className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-12">
        ...
        >
          ...
          <h1 className="text-balance text-5xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
            <span className="text-gradient">BUILD WITH AI</span>
            <br />
